...
class AppDelegate: UIResponder, UIApplicationDelegate,PushNotificationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        players.append(Player(name: "Ajay Kumar", achieve: "School u19 (Gold) 4-10-2011 to 8-10-2011, Junior National Championship 27-12-2011 to 30-12-2011  (Bronze), Senior National Championship 24-11-2015 to 29-11-2015 (Bronze), Federation cup 1-5-2016 to 5-5-2016 (Gold)", tour: "", age: "22", type: "Raider", state: "Haryana", jerseyNo: "33", image: "ic_action_panther-1.jpg"))
