...
class AppDelegate: UIResponder, UIApplicationDelegate,PushNotificationDelegate, UNUserNotificationCenterDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        players.append(Player(name: "Deepak Hooda", achieve: "2015-16 Pro Kabaddi League (Patna Pirates), 2010-16 Senior State Campionship, 2015 Senior Nationals, 2016 Departmental Nationals, 2016 Federation Cup", tour: "2016 Pro Kabaddi League (Gold), 2015 Senior Nationals (Bronze), 2016 Federation Cup (Silver), 2016 Departmental Nationals (Gold), 2012,14,16 Senior State Championship (Silver), 2013 Senior State Championship (Gold)", age: "20", type: "Defender", state: "Haryana", jerseyNo: "10", image: "p26.jpg"))
        players.append(Player(name: "Selvamani Kannan", achieve: "2014-15 Junior National Games, 2015 U-19 School Games, 2016 Junior Asian Championship", tour: "2015 U-19 School Games(Bronze), 2016 Junior Asian Championship (Gold) ", age: "18", type: "Raider", state: "New Delhi", jerseyNo: "4", image: "p21.jpg"))
        ...
        players.append(Player(name: "Bajirao Hodage", achieve: "", tour: "2016 Pro Kabaddi League (Dabang Delhi K.C.)", age: "26", type: "Raider", state: "New Taipei City", jerseyNo: "9", image: "lo_chia.png"))
        ...
        players.append(Player(name: "Brijendra Choudhary", achieve: "2011-12 U-19 School National Games, 2016 Departmental Nationals, 2013 Junior National Championship,2015 University Games", tour: "2016 Star Sports Pro Kabaddi semi-finalist team (Puneri Paltan), 2011 U-19 School National Games (Gold), 2012 U-19 School National Games (Silver)", age: "21", type: "All rounder", state: "Maharashtra", jerseyNo: "99", image: "p28.jpg"))
